...
function Nav() {
  ...
  const navItems = (
    <>
      <li>
        <a href="/" className="dark:text-black md:dark:text-white">Home</a>
      </li>
      <li>
        <a href="/course" className="dark:text-black md:dark:text-white">Course</a>
      </li>
      <li>
        <a className="dark:text-black md:dark:text-white">Contact</a>
      </li>
      <li>
        <a className="dark:text-black md:dark:text-white">About</a>
      </li>
    </>
  );
      ...
      <div className="navbar ">
        <div className="navbar-start">
          <div className="dropdown">
            {/* <!-- This button should be hidden on lg and larger screens --> */}
